...
int main(int argc, char **argv) {
  ...
  // Intialize motors
  left_motor = wb_robot_get_device("left_main_wheel_joint");
  right_motor = wb_robot_get_device("right_main_wheel_joint");
  ...
  // Intialize sensors
  left_IR = wb_robot_get_device("left_distance_sensor");
  right_IR = wb_robot_get_device("right_distance_sensor");
